...
function Projects() {
  const portfolios = [
    ...
    },
    {
      ...
      description: "Viewify is a dynamic Video Sharing Platform developed using MERN stack and Tailwind CSS, akin to YouTube, providing users with the ability to upload, view, and share videos effortlessly",
    ...
    },
    {
      ...
      src: project3,
      title: "GrowTogethor",
      description: "GrowTogether is an android app developed for farmers, offering chat, government schemes, and expert advice on agriculture.",
